...
License:	W3C
Group:		Libraries
Source0:	http://www.w3.org/2002/06/%{orgname}java-%{version}.zip
# Source0-md5:	91c083636dc1a926bcb5b0bd0bde9ea5
Source1:	%{orgname}-build.xml
Source2:	%{orgname}-MANIFEST.MF
Source3:	http://mirrors.ibiblio.org/pub/mirrors/maven2/org/w3c/css/sac/1.3/%{orgname}-%{version}.pom
